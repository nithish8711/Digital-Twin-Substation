...
export function CircuitBreakerPanel() {
  const data = useLiveData("circuitBreaker", dataGenerators.circuitBreaker)
  const [selectedParameter, setSelectedParameter] = useState<string | null>(null)

  const preferredOrder = ["sf6Density", "operationCount", "operationTime", "breakerStatus"]
  ...
  return (
    <Card className="h-full overflow-hidden flex flex-col">
      <CardHeader className="flex-shrink-0">
        <CardTitle>Circuit Breaker Live Parameters</CardTitle>
      </CardHeader>
